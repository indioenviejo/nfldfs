...
# playerHMEAvgPerf.to_csv("/home/raghav/playerHome.csv")
# 
# ###############################################################################################################
#  
# # Get Defense Teams
...
# 
# 
# teamHMEAvgPerfNorm.to_csv("/home/raghav/teamNormHome.csv")
# teamAWYAvgPerfNorm.to_csv("/home/raghav/teamNormAway.csv")
# 
# 
# # ############################################################################################################### 
# [away,home] = ComputationBlocks.getHomenAwy(playerStats["NextGame"])
# 
# 
...
# print "-----------------------------------------"
# 
# offensiveMatchup.to_csv("/home/raghav/offMatchup.csv",index=None)
...
x = pda.read_csv("/home/raghav/offMatchup.csv")
...
x.to_csv("/home/raghav/Wk13PlayerValue.csv")
